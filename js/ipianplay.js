! function(e, t) {
    ...
    return function(e) {
        ...
        function(e, t, n) {
            ...
            console.log('%c爱片网播放器', 'font-size:2em');
            console.log("别看了，这里没有你想要的东西");
                    ...
                    return o(e, [{
                        ...
                        value: function() {
                            ...
                            if (this.paused = !1, this.video.paused && this.bezel.switch(v.default.play), this.template.playButton.innerHTML = v.default.pause, r.default.resolve(this.video.play()).catch(function() {
                                e.pause()
                            }).then(function() {}), this.time.enable("loading"), this.time.enable("progress"), this.container.classList.remove("leleplayer-paused"), this.container.classList.add("leleplayer-playing"), this.danmaku && this.danmaku.play(), this.options.mutex)
                            ...
                            if (this.qualityIndex !== e && !this.switchingQuality) {
                                ...
                                this.template.videoWrap.insertBefore(a, this.template.videoWrap.getElementsByTagName("div")[0]), this.prevVideo = this.video, this.video = a, this.initVideo(this.video, this.quality.type || this.options.video.type), this.seek(this.prevVideo.currentTime), this.notice(this.tran("Switching to") + " " + this.quality.name + " " + this.tran("quality"), -1), this.events.trigger("quality_start", this.quality), this.on("canplay", function() {
                                    if (t.prevVideo) {
                                        ...
                                        t.template.videoWrap.removeChild(t.prevVideo), t.video.classList.add("leleplayer-video-current"), n || t.video.play(), t.prevVideo = null, t.notice(t.tran("Switched to") + " " + t.quality.name + " " + t.tran("quality")), t.switchingQuality = !1, t.events.trigger("quality_end")
                                    }
                                })
                            }
                        }
            ...
            var a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
                ...
                s = function() {
                    ...
                    return o(e, [{
                        ...
                        value: function(e) {
                            if (void 0 !== e) {
                                for (var t = this.container.getElementsByClassName("leleplayer-danmaku-item"), n = 0; n < t.length; n++) t[n].style.opacity = e;
                        ...
                        value: function(e) {
                            ...
                            if (this.showing) {
                                ...
                                for (var u = document.createDocumentFragment(), d = 0; d < e.length; d++)! function(a) {
                                    ...
                                    o.classList.add("leleplayer-danmaku-item"), o.classList.add("leleplayer-danmaku-" + e[a].type), e[a].border ? o.innerHTML = '<span style="border-bottom:' + e[a].border + '">' + e[a].text + "</span>" : o.innerHTML = e[a].text, o.style.opacity = t._opacity, o.style.color = e[a].color, o.style.fontSize = e[a].size, o.addEventListener("animationend", function() {
                                    ...
                                    r >= 0 && (o.classList.add("leleplayer-danmaku-move"), u.appendChild(o))
                                }(d);
                        ...
                        key: "resize",
                        value: function() {
                            for (var e = this.container.offsetWidth, t = this.container.getElementsByClassName("leleplayer-danmaku-item"), n = 0; n < t.length; n++) t[n].style.transform = "translateX(-" + e + "px)"
                        }
                    }, {
                        key: "hide",
                        value: function() {
                        ...
                        value: function() {
                            ...
                            switch (n || (this.lastScrollPosition = s.default.getScrollPosition()), e) {
                                case "browser":
                                    ...
                                    break;
                                case "web":
                                    this.player.container.classList.add("leleplayer-fulled"), document.body.classList.add("leleplayer-web-fullscreen-fix"), this.player.events.trigger("webfullscreen")
                            }
                            n && this.cancel(t)
                        }
                    }, {
                        ...
                        value: function() {
                            switch (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "browser") {
                                case "browser":
                                    ...
                                    break;
                                case "web":
                                    this.player.container.classList.remove("leleplayer-fulled"), document.body.classList.remove("leleplayer-web-fullscreen-fix"), this.player.events.trigger("webfullscreen_cancel")
                            }
                        }
                    }, {
                        key: "toggle",
            ...
            var a = function() {
                ...
                o = function() {
                    ...
                    return a(e, [{
                        ...
                        key: "show",
                        value: function() {
                            this.container.classList.remove("leleplayer-subtitle-hide"), this.events.trigger("subtitle_show")
                        }
                    }, {
                        key: "hide",
                        value: function() {
                            this.container.classList.add("leleplayer-subtitle-hide"), this.events.trigger("subtitle_hide")
                        }
                    }, {
                        key: "toggle",
                        value: function() {
                    ...
                    return a(e, [{
                        ...
                        value: function() {
                            ...
                            this.loadingChecker = setInterval(function() {
                                e.enableloadingChecker && (n = e.player.video.currentTime, i || n !== t || e.player.video.paused || (e.player.container.classList.add("leleplayer-loading"), i = !0), i && n > t && !e.player.video.paused && (e.player.container.classList.remove("leleplayer-loading"), i = !1), t = n)
                            }, 100)
                        }
                    }, {
            ...
            var a = function() {
                ...
                o = function() {
                    ...
                    return a(e, [{
                        key: "switch",
                        value: function(e) {
                            this.container.innerHTML = e, this.container.classList.add("leleplayer-bezel-transition")
                        }
                    }]), e
                }();
            t.default = o
                    ...
                    return o(e, [{
                        ...
                        value: function() {
                            var e = this,
                                ...
                                n = function n() {
                                    document.removeEventListener(r.default.nameMap.dragEnd, n), document.removeEventListener(r.default.nameMap.dragMove, t), e.player.template.volumeButton.classList.remove("leleplayer-volume-active")
                                };
                            this.player.template.volumeBarWrapWrap.addEventListener("click", function(t) {
                                ...
                                document.addEventListener(r.default.nameMap.dragMove, t), document.addEventListener(r.default.nameMap.dragEnd, n), e.player.template.volumeButton.classList.add("leleplayer-volume-active")
                        ...
                        value: function() {
                            ...
                            this.player.options.screenshot && this.player.template.camareButton.addEventListener("click", function() {
                                ...
                                var n = t.toDataURL();
                                e.player.template.camareButton.href = n, e.player.template.camareButton.download = "leleplayer.png", e.player.events.trigger("screenshot", n)
                            })
                        }
                    }, {
                        ...
                        key: "hide",
                        value: function() {
                            this.player.container.classList.add("leleplayer-hide-controller"), this.player.setting.hide(), this.player.comment && this.player.comment.hide()
                        }
                    }, {
                        key: "isShow",
                        value: function() {
                ...
                r = function() {
                    function e(t) {
                        ...
                        i(this, e), this.player = t, this.player.template.mask.addEventListener("click", function() {
                            ...
                            n.player.template.settingBox.classList.add("leleplayer-setting-box-narrow"), n.player.template.settingBox.classList.add("leleplayer-setting-box-speed")
                        });
                        ...
                        if (this.player.danmaku) {
                            ...
                            var o = function(e) {
                                ...
                                r = function e() {
                                    document.removeEventListener(s.default.nameMap.dragEnd, e), document.removeEventListener(s.default.nameMap.dragMove, o), n.player.template.danmakuOpacityBox.classList.remove("leleplayer-setting-danmaku-active")
                                };
                            this.player.template.danmakuOpacityBarWrapWrap.addEventListener("click", function(e) {
                                ...
                                document.addEventListener(s.default.nameMap.dragMove, o), document.addEventListener(s.default.nameMap.dragEnd, r), n.player.template.danmakuOpacityBox.classList.add("leleplayer-setting-danmaku-active")
                            })
                        }
                    }
                    return a(e, [{
                        ...
                        value: function() {
                            var e = this;
                            this.player.template.settingBox.classList.remove("leleplayer-setting-box-open"), this.player.template.mask.classList.remove("leleplayer-mask-show"), setTimeout(function() {
                                e.player.template.settingBox.classList.remove("leleplayer-setting-box-narrow"), e.player.template.settingBox.classList.remove("leleplayer-setting-box-speed")
                            }, 300), this.player.controller.disableAutoHide = !1
                        }
                    }, {
                        key: "show",
                        value: function() {
                            this.player.template.settingBox.classList.add("leleplayer-setting-box-open"), this.player.template.mask.classList.add("leleplayer-mask-show"), this.player.controller.disableAutoHide = !0
                        }
                    }]), e
                }();
            t.default = r
            ...
            var a = function() {
                ...
                o = function() {
                    ...
                    return a(e, [{
                        key: "show",
                        value: function() {
                            this.player.controller.disableAutoHide = !0, this.player.template.controller.classList.add("leleplayer-controller-comment"), this.player.template.mask.classList.add("leleplayer-mask-show"), this.player.container.classList.add("leleplayer-show-controller"), this.player.template.commentInput.focus()
                        }
                    }, {
                        key: "hide",
                        value: function() {
                            this.player.template.controller.classList.remove("leleplayer-controller-comment"), this.player.template.mask.classList.remove("leleplayer-mask-show"), this.player.container.classList.remove("leleplayer-show-controller"), this.player.controller.disableAutoHide = !1, this.hideSetting()
                        }
                    }, {
                        key: "showSetting",
                        value: function() {
            ...
            var a = function() {
                ...
                o = function() {
                    ...
                    return a(e, [{
                        key: "show",
                        value: function() {
                            this.beginTime = Date.now(), this.update(), this.player.time.enable("info"), this.player.time.enable("fps"), this.container.classList.remove("leleplayer-info-panel-hide")
                        }
                    }, {
                        key: "hide",
                        value: function() {
                            this.player.time.disable("info"), this.player.time.disable("fps"), this.container.classList.add("leleplayer-info-panel-hide")
                        }
                    }, {
                        key: "triggle",
                        value: function() {
...
//统计代码
document.write('<script async src="https://www.googletagmanager.com/gtag/js?id=UA-118580329-2"><\/script>');
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-118580329-2');